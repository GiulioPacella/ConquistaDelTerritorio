...
- **Macchina a stati**: `ST_CONNESSO` ammette solo `REGISTER/LOGIN/QUIT`; `ST_IN_GIOCO` ammette `MOVE/WHO/MAP/QUIT`. Comando valido ma in stato errato → `ERR` esplicativo. Il dispatch è in `gestisci_riga`.
